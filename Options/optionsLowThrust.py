# FORM: opts['thrust'] = optionsLowThrust(opts,selection)
# |-----------------------------------------------------------------------
# |
# | NOTES:
...
def  optionsLowThrust(opts,selection):
...
# %%Selection
    ...
    if selection == 'Custom-1':
        
        opt_thrust['Nseg'] = 10
        opt_thrust['orbit_check'] = 'off'
        opt_thrust['orbits'] = 0
        opt_thrust['tt_end'] = opts['tof_total']
        opt_thrust['time'] = opts['tof_margin']
        opt_thrust['m0']= 24235
        ...
        opt_thrust['mdot_method'] = 'constant'
        opt_thrust['mdot'] = 6.787e-5
        opt_thrust['Isp'] = 3000
        opt_thrust['n_available'] = 1
        opt_thrust['duty_cycle_type'] = 'calculated'
        opt_thrust['duty_cycle'] = 1
        
    elif selection == 'Yam-STOUR':
        ...
        opt_thrust['time'] = opts['tof_margin']
        opt_thrust['m0']= 20000
        opt_thrust['thrust_method'] = 'variable'
        opt_thrust['thrust'] = (0,2.26) # Thrust Range (N)
        opt_thrust['mdot_method'] = 'constant'
        opt_thrust['mdot'] = 3.84e-5
        opt_thrust['Isp'] = 6000
        opt_thrust['n_available'] = 5
        ...
        raise Exception("Low Thrust Options invalid")
